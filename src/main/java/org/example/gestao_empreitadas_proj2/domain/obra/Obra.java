...
public class Obra {
    ...
    @JoinColumn(name = "propostaid", nullable = true)
    ...
    public void setPercentagemconclusao(BigDecimal p) { this.percentagemconclusao = p; }
    public Funcionario getDirectorobra() { return directorobra; }
    public void setDirectorobra(Funcionario directorobra) { this.directorobra = directorobra; }
