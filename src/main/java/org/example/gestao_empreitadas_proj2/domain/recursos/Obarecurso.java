...
public class Obarecurso {
    ...
    public void setFuncionarioid(Funcionario funcionarioid) { this.funcionarioid = funcionarioid; }
    public Integer getHorasalocadas() { return horasalocadas; }
    public void setHorasalocadas(Integer horasalocadas) { this.horasalocadas = horasalocadas; }
